...
export default function Workflow() {
  return (
    ...
    <section className='md:my-16 md:mx-16 background-card'>
      <h2 className="grid md:pl-5 text-4xl md:pl-10 md:pt-5 uppercase font-light text-slate-950">
          Workflow
        </h2>

        <div className='md:px-5 md:px-10 pt-5 pb-12 grid md:grid-cols-3 md:gap-6 text-slate-900 lg:grid-cols-6 lg:gap-6'>
            <div className=''>
            <h3 className='font-medium text-base uppercase'>Discover & Define</h3>
          <p className='font-light text-base leading-[22px] pb-5'>
            ...
            <div className=''>
            <h3 className='font-medium text-base uppercase'>Information Architecture & Site Mapping</h3>
              <p className='font-light text-base leading-5 pb-5'>
            ...
            <div className=''>
            <h3 className='font-medium text-base uppercase'>Wire framing & Prototyping</h3>
              <p className='font-light text-base leading-[22px] pb-5'>
            ...
            <div className=''>
            <h3 className='font-medium text-base uppercase'>Visual Design & UI Refinement</h3>
              <p className='font-light text-base leading-[22px] pb-5'>
            ...
            <div className=''>
            <h3 className='font-medium text-base uppercase'>Usability Testing & Iteration</h3>
              <p className='font-light text-base leading-[22px] pb-5'>
            ...
            <div className=''>
            <h3 className='font-medium text-base uppercase'>Handoff & Development</h3>
