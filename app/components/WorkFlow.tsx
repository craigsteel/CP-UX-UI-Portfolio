...
export default function Workflow() {
  return (
    ...
    <section>
      <div className='relative z-0 mx-10 mt-10 rounded-lg bg-gradient-to-tr from-slate-100 from-40% via-blue-300 via-60% to-slate-300 opacity-70 hover:opacity-100 hover:drop-shadow-[0_0px_70px_rgba(0,0,0,1)] hover:scale-105 transition duration-500 ease-in-out'>
        <h2 className="grid pl-10 py-5 text-2xl uppercase font-light text-slate-950">
          Workflow
        </h2>
